...
#
{
    ...
    # old UTF-8 regexp mark last m// or qr// matched
    sub Eoldutf8::m_matched() {
        $last_s_matched = 0;
    }

    # old UTF-8 regexp mark last s/// or qr matched
    ...
    @Eoldutf8::m_matched = (qr/(?{Eoldutf8::m_matched})/);
    @Eoldutf8::s_matched = (qr/(?{Eoldutf8::s_matched})/);
}
