...
You need write 'use OldUTF8;' in your script.
  ...
  Before      After
  ---------------------------------
  use utf8;   use OldUTF8;
  ---------------------------------

=head1 Escaping Multiple Octet Code (OldUTF8 software provides)
...
=head1 Escaping Character Classes (OldUTF8 software provides)
...
functions.
  ...
  y///B       tr///
  chop        Eoldutf8::chop
  index       Eoldutf8::index
  rindex      Eoldutf8::rindex
  chr         Eoldutf8::chr
  glob        Eoldutf8::glob
  ---------------------------------
...
=head1 Escaping Built-in Standard Module (OldUTF8 software provides)
